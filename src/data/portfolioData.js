...
export const SKILLS = [
  { name: "Java / C++", icon: "☕", level: 95, color: "#f89820" },
  { name: "Spring Boot", icon: "🌱", level: 92, color: "#6DB33F" },
  { name: "Microservices", icon: "🔗", level: 90, color: "#ec4899" },
  ...
  { name: "Domain-Driven Design (DDD)", icon: "🏗️", level: 88, color: "#f78166" },
  { name: "Spring AI & GenAI", icon: "🤖", level: 88, color: "#bc8cff" },
  { name: "Agentic AI & RAG", icon: "🧠", level: 85, color: "#a855f7" },
  { name: "OAuth 2.0 / Keycloak", icon: "🔐", level: 84, color: "#ec4899" },
];

export const TECH_BADGES = [
  ["Java", "C++", "SQL", "Python", "Data Structures & Algorithms"],
  ["Spring Boot", "Spring Cloud", "Spring Security", "Spring AI", "Hibernate", "JUnit 5", "LangChain"],
  ["Generative AI", "Agentic AI", "RAG", "LangFuse", "OpenTelemetry", "Structured Logging"],
  ["AWS (EC2, ECS, Lambda, S3)", "IAM", "CloudFormation", "OAuth 2.0", "JWT", "Keycloak"],
  ["MySQL", "PostgreSQL", "Apache Kafka", "RabbitMQ", "Swagger (OpenAPI)", "Postman"],
  ["Docker", "Git", "GitHub", "Agile Methodologies", "Code Reviews", "Prometheus & Grafana"],
];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    subtitle: "Full-Stack GenAI E-Commerce App",
    period: "Sep 2025 – Dec 2025",
    emoji: "📚",
    gradient: "from-purple-500 to-indigo-600",
    glow: "#8338ec",
    desc: "Full-stack e-commerce marketplace featuring secure payment integration, role-specific control panels, and an automated customer service chatbot.",
    points: [
      ...
      "Improved API response time through optimized Spring Boot services and efficient database query design, enhancing overall performance under concurrent loads.",
      ...
      "Documented 15+ RESTful APIs using Swagger (OpenAPI) and delivered features in Agile sprints in collaboration with UI/UX and QA teams."
    ],
    metrics: [{ v: "Spring AI", l: "Support Chatbot" }, { v: "Razorpay", l: "Payments Gateway" }, { v: "3", l: "User Roles" }],
    tags: ["Java", "Spring Boot", "Spring AI", "React.js", "MySQL", "JWT", "Razorpay", "Cloudinary"],
    github: "https://github.com/yeshant1",
  },
];
